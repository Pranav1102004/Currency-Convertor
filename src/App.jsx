...
import {InputBox} from './commponents/input'
import useCurrencyInfo from './Hooks/useCurrencyInfo'



function App() {
  const [ammonut,setAmmount] = useState(0);
  ...
  const swap = ()=>{
    setFrom(to)
    setTo(from)
    setConvertedAmmount(ammonut)
    setAmmount(convertedAmmount)
  }
  const convert = ()=>{
    setConvertedAmmount(Number(ammonut)*currencyInfo[to])
  }
  return (
    <>
    <div
                ...
                >
                    <div className="w-full mb-1">
                        <InputBox
                            ...
                            onAmmonutChange={(ammonut)=> setAmmount(ammonut)}
                            selectCurrency={from}
